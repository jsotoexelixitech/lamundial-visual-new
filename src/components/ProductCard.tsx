...
const CARD_CONFIG = {
  rcv: {
    ...
    btnColor: 'linear-gradient(135deg, #D01229 0%, #9B0D1E 100%)',
    btnHover: 'rgba(208,18,41,0.08)',
  },
  patrimonial: {
    ...
    stepColor: 'bg-yellow-100 text-yellow-800',
    btnColor: 'linear-gradient(135deg, #C8A94E 0%, #A88A35 100%)',
    btnHover: 'rgba(200,169,78,0.08)',
  },
  funerario: {
    ...
    stepColor: 'bg-gray-100 text-gray-700',
    btnColor: 'linear-gradient(135deg, #404040 0%, #1A1A1A 100%)',
    btnHover: 'rgba(64,64,64,0.08)',
  },
};
